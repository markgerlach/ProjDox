    ...
    public partial class DAL // : IDisposable
    {
		...
		public static string ConnString
		{
			get
			{
				...
				{
					m_sConn = "Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=<DBName>;Data Source=(local)";
				}
				return m_sConn;
			}
			set { m_sConn = value; }
		...
		public static readonly Guid _EmptyGuid = Guid.Empty;
		public static readonly int _EmptyInt = -1;
		public static readonly double _EmptyDouble = -1;
		public static readonly decimal _EmptyDecimal = -1;
		public static readonly DateTime _EmptyDateTime = DateTime.Parse("1/1/1900");
		public static readonly string _EmptyString = string.Empty;

		public static readonly string _DateFormat = "MM/dd/yyyy";
		public static readonly string _TimeFormat = "hh:mm:ss";
		public static readonly string _DateTimeFormat = _DateFormat + " " + _TimeFormat;
